...
import { Mail, GraduationCap, AlertCircle, Loader2, CheckCircle2, ArrowLeft } from 'lucide-react';
          ...
          {!success ? (
            ...
            >
              ...
              <div className="space-y-3">
                <Link to="/login">
                  <Button
                    className="w-full h-12 whitespace-nowrap bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white"
                  >
                    Voltar para login
                  </Button>
                </Link>
